...
def persist_components(db: Session, batch: Batch, df: pd.DataFrame):
    ...
    for _, row in df.iterrows():
        records.append(ComponentRecord(
            ...
            predicted_drift_168=row.get("predicted_drift_168"),
            predicted_drift_rate=row.get("predicted_drift_rate"),
            safety_slope=row.get("safety_slope"),
            ...
            behavioral_health=row.get("behavioral_health", "NORMAL"),
