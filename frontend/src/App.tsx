...
export default function App() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden text-[#17212B] flex flex-col bg-[#F4F7FB]">
      ...
      {quarantineToast && !alertComponent && (
        <div className="bg-[#FEF2F2] border-b border-[#D9363E]/40 border-l-4 border-l-[#D9363E] px-5 py-2 flex items-center justify-between gap-3 text-xs font-mono text-[#17212B] animate-alert-once z-30 shadow-sm">
      ...
      <div className="flex-1 min-h-0 flex flex-row w-full overflow-hidden relative">
        ...
        <main className="flex-1 min-w-0 min-h-0 overflow-y-auto bg-[#F4F7FB] flex flex-col relative">
