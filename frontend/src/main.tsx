...
> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ padding: 32, color: '#EF4444', background: '#FFFFFF', fontFamily: "'Sitka Small Semibold', 'Sitka Small', Georgia, serif", minHeight: '100vh', zIndex: 99999 }}>
          ...
          <pre style={{ background: '#F8FAFC', color: '#17212B', padding: 16, borderRadius: 6, border: '1px solid #D9E2EA', overflowX: 'auto', fontSize: 12, lineHeight: 1.5 }}>
          ...
          <button
            ...
            style={{ marginTop: 20, padding: '10px 24px', background: '#10B981', color: '#FFFFFF', border: 'none', borderRadius: 4, fontWeight: 'bold', cursor: 'pointer', fontFamily: "'Sitka Small Semibold', 'Sitka Small', Georgia, serif", letterSpacing: '1px' }}
          >
            &#8635; REINITIALIZE SYSTEM
          </button>
        </div>
