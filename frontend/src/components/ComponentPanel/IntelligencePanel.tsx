...
export function ComponentOverviewCard({ component }: { component: ComponentOut | null }) {
  if (!component) {
    return (
      <div className="bg-[#FFFFFF] p-5 rounded-xl border border-[#D9E2EA] flex flex-col justify-center items-center text-center font-sans h-full min-h-[460px]">
        ...
        <div className="text-[#5B6B7A] text-xs leading-relaxed py-6 px-4 border border-dashed border-[#D9E2EA] rounded-lg max-w-xs">
  ...
  return (
    <div className="bg-[#FFFFFF] p-4 md:p-5 rounded-xl border border-[#D9E2EA] flex flex-col justify-between h-full font-sans text-xs shadow-md">
      <div>
        {/* Header */}
        <div className="flex items-center justify-between pb-2.5 border-b border-[#D9E2EA] mb-3.5">
        ...
        <div className="bg-[#FFFFFF] p-3.5 rounded-xl border border-[#D9E2EA] mb-3.5 shadow-sm">
          <div className="flex items-baseline justify-between">
            <div className="text-base font-bold text-[#17212B] font-mono tracking-wide">
              {component.component_id}
            </div>
            <div className="text-xs text-[#5B6B7A] font-mono">
          ...
          <div className="text-xs text-amber-400 mt-1.5 font-medium flex items-center justify-between">
            ...
            <span className="text-[10.5px] text-[#5B6B7A] uppercase font-mono">{component.parameter || 'Leakage Current (µA)'}</span>
          </div>
        </div>

        {/* Traditional vs AI Verdict Comparison Box */}
        <div className="mb-3.5 p-3.5 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA] text-xs space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-[#5B6B7A] font-medium">Traditional Spec Check:</span>
          ...
          <div className="flex justify-between items-center">
            <span className="text-[#5B6B7A] font-medium">AI Lot-Relative Verdict:</span>
          ...
          {isAbnormalInSpec ? (
            ...
            <div className="pt-1.5 text-[11px] text-[#5B6B7A] border-t border-[#D9E2EA]/80 flex justify-between font-mono">
              <span>Evaluation Protocol:</span>
              <span className="text-[#5B6B7A] font-semibold">MIL-STD-883 HTOL 168H</span>
            </div>
          )}
        </div>

        {/* Burn-In Measurements (0h, 24h, 96h, 168h) */}
        <div className="p-3.5 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA]">
          <div className="text-[10.5px] text-[#5B6B7A] uppercase font-semibold mb-2.5 flex items-center justify-between">
          ...
          <div className="grid grid-cols-4 gap-2.5 text-center font-mono">
            <div className="bg-[#F8FAFC] p-2.5 rounded-lg border border-[#D9E2EA]">
              <div className="text-[10px] text-[#5B6B7A] uppercase font-semibold mb-0.5">0h</div>
              <div className="text-[#17212B] font-bold text-sm">{component.v0.toFixed(2)}</div>
            </div>
            <div className="bg-[#F8FAFC] p-2.5 rounded-lg border border-[#D9E2EA]">
              <div className="text-[10px] text-[#5B6B7A] uppercase font-semibold mb-0.5">24h</div>
              <div className="text-[#17212B] font-bold text-sm">{component.v24.toFixed(2)}</div>
            </div>
            <div className="bg-[#F8FAFC] p-2.5 rounded-lg border border-[#D9E2EA]">
              <div className="text-[10px] text-[#5B6B7A] uppercase font-semibold mb-0.5">96h</div>
              <div className="text-[#17212B] font-bold text-sm">{component.v96 != null ? component.v96.toFixed(2) : '--'}</div>
            </div>
            <div className="bg-[#F8FAFC] p-2.5 rounded-lg border border-[#D9E2EA]">
              <div className="text-[10px] text-[#5B6B7A] uppercase font-semibold mb-0.5">168h</div>
      ...
      <div className="mt-3.5 pt-2.5 border-t border-[#D9E2EA]/80 flex items-center justify-between text-[11px] font-mono text-[#5B6B7A]">
...
export function MathematicalReadingsPanel({ component }: { component: ComponentOut | null }) {
  ...
  return (
    <div className="bg-[#FFFFFF] p-4 md:p-5 rounded-xl border border-[#D9E2EA] flex flex-col gap-4 font-sans text-xs shadow-md w-full">
      {/* Header */}
      <div className="flex flex-wrap items-center justify-between gap-2 pb-2.5 border-b border-[#D9E2EA]">
        <div className="flex items-center gap-2">
          <span className="w-2.5 h-2.5 rounded-full bg-amber-400 led" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <div className="p-3 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA] flex flex-col justify-between gap-1">
          <span className="text-[#5B6B7A] text-[11px] uppercase font-semibold">Datasheet Limit</span>
          <span className="font-mono text-base font-bold text-rose-400">{component.limit_ua.toFixed(0)} µA</span>
          <span className="text-[10px] text-[#5B6B7A]">Standard spec ceiling</span>
        </div>

        {/* Metric 2 */}
        <div className="p-3 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA] flex flex-col justify-between gap-1">
          <span className="text-[#5B6B7A] text-[11px] uppercase font-semibold">Lot Median</span>
        ...
        {/* Metric 3 */}
        <div className="p-3 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA] flex flex-col justify-between gap-1">
          <span className="text-[#5B6B7A] text-[11px] uppercase font-semibold">Lot MAD</span>
          <span className="font-mono text-base font-bold text-[#17212B]">
            {component.lot_mad != null ? `±${component.lot_mad.toFixed(2)} µA` : component.lot_std != null ? `±${component.lot_std.toFixed(2)} µA` : '--'}
          </span>
          <span className="text-[10px] text-[#5B6B7A]">Robust absolute deviation</span>
        </div>

        {/* Metric 4 */}
        <div className="p-3 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA] flex flex-col justify-between gap-1">
          <span className="text-[#5B6B7A] text-[11px] uppercase font-semibold">Lot z-Score</span>
          ...
          <span className="text-[10px] text-[#5B6B7A]">Standard normal quantile</span>
        </div>

        {/* Metric 5 */}
        <div className="p-3 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA] flex flex-col justify-between gap-1">
          <span className="text-[#5B6B7A] text-[11px] uppercase font-semibold">Drift % (168h vs 0h)</span>
          <span className={`font-mono text-base font-bold ${
            Math.abs(component.pct_drift) >= 60 ? 'text-rose-400' : Math.abs(component.pct_drift) >= 40 ? 'text-amber-400' : 'text-[#17212B]'
          }`}>
            {component.pct_drift > 0 ? '+' : ''}{component.pct_drift.toFixed(1)}%
          </span>
          <span className="text-[10px] text-[#5B6B7A]">Total burn-in divergence</span>
        </div>

        {/* Metric 6 */}
        <div className="p-3 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA] flex flex-col justify-between gap-1">
          <span className="text-[#5B6B7A] text-[11px] uppercase font-semibold">Drift Slope</span>
          <span className="font-mono text-base font-bold text-amber-300">{component.slope.toFixed(4)} µA/hr</span>
          <span className="text-[10px] text-[#5B6B7A] truncate">{component.drift_trend || 'NOMINAL / STABLE'}</span>
        </div>

        {/* Metric 7 */}
        <div className="p-3 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA] flex flex-col justify-between gap-1">
          <span className="text-[#5B6B7A] text-[11px] uppercase font-semibold">Predicted 168h (Early)</span>
          <span className="font-mono text-base font-bold text-[#17212B]">{component.predicted168_from_early.toFixed(2)} µA</span>
          <span className="text-[10px] text-[#5B6B7A] truncate">
        ...
        {/* Metric 8 */}
        <div className="p-3 rounded-xl bg-[#FFFFFF] border border-[#D9E2EA] flex flex-col justify-between gap-1">
          <span className="text-[#5B6B7A] text-[11px] uppercase font-semibold">Projected Future (264h)</span>
          <span className={`font-mono text-base font-bold ${
