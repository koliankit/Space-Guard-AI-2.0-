      ...
      <div className="w-full max-w-5xl max-h-[92vh] bg-[#060B16] border-2 border-isro-amber/80 rounded-lg shadow-[0_0_50px_rgba(245,158,11,0.2)] flex flex-col overflow-hidden relative reticle-corner">
        ...
        <div className="px-6 py-4 border-b border-line bg-gradient-to-r from-[#0E1726] via-[#091120] to-[#0A1A17] flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            <div className="w-11 h-11 rounded border border-isro-amber/80 bg-[#170E04] flex flex-col items-center justify-center text-isro-amber font-display font-black text-xs shadow-[0_0_15px_rgba(245,158,11,0.3)]">
              <span>ISRO</span>
          ...
          <button
            ...
            className="text-muted hover:text-white border border-line hover:border-isro-amber px-3 py-1 rounded text-xs transition-all flex items-center gap-1.5"
          >
            <span>CLOSE</span>
        ...
        <div className="flex border-b border-line bg-[#080E1A] overflow-x-auto">
          {PITCH_SECTIONS.map((sec) => (
            <button
              ...
              className={`flex-1 min-w-[160px] px-4 py-2.5 text-left transition-all border-r border-line/60 flex flex-col justify-center ${
                activeSlide === sec.id
                  ? 'bg-isro-amber/15 border-b-2 border-b-isro-amber text-white shadow-inner'
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-sm">
          ...
          {activeSlide === 0 && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#170B0E] border border-reject/60 p-4 rounded">
                ...
                <div className="bg-[#071912] border border-safe/60 p-4 rounded">
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-[#070D18] p-4 rounded border border-line font-mono text-xs space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-slate-300">
                  <div className="p-2.5 rounded bg-[#0A1424] border border-line/60">
          ...
          {activeSlide === 2 && (
            <div className="space-y-6 animate-fadeIn">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                <div className="bg-[#0A1424] p-4 rounded border border-isro-amber/40">
                ...
                <div className="bg-[#0A1424] p-4 rounded border border-safe/40">
              ...
              <div className="bg-[#070E1A] p-4 rounded border border-line space-y-3">
          ...
          {activeSlide === 3 && (
            <div className="space-y-6 animate-fadeIn">
              <div className="bg-[#0A1424] p-4 rounded border border-isro-amber/40 flex items-start gap-4">
                <div className="text-3xl">🔒</div>
                <div>
          ...
          {activeSlide === 4 && (
            <div className="space-y-6 animate-fadeIn">
              <div className="bg-[#071912] p-4 rounded border border-safe/50 text-xs">
                ...
                {ISRO_MISSIONS.map((m) => (
                  ...
                  >
                    <div>
                      ...
                      <h4 className="text-white font-display font-bold text-xs group-hover:text-isro-amber transition-colors">
                        {m.name}
                      </h4>
        ...
        {/* Modal Footer */}
        <div className="px-6 py-3 border-t border-line bg-[#080E1A] flex items-center justify-between text-xs">
