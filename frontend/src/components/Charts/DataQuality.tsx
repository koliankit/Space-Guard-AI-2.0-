export default function DataQuality({
  ...
  const item = (label: string, value: string | number | null, color = 'text-isro-amber') => (
    <div className="bg-[#0A1322] p-2 rounded border border-line">
  ...
  return (
    <div className="bg-panel p-4 border-r border-line">
      <div className="flex items-center justify-between mb-3">
        <h3 className="m-0 text-[11px] font-display tracking-widest uppercase text-isro-amber flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-isro-amber led shadow-sm" />
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        {item('Component Lots', lots, 'text-isro-amber')}
