  ...
  return (
    <div className="fixed inset-0 bg-black/85 z-50 flex items-center justify-center p-4 backdrop-blur-md">
      <div className="w-[460px] max-w-[94vw] bg-[#0B1120] border-2 border-reject/80 rounded-lg p-6 shadow-alert-glow modal-anim relative font-mono">
        ...
        <div className="flex items-center gap-2 text-reject font-display font-bold text-xs tracking-wider mb-2">
        ...
        <button
          type="button"
          className="w-full font-display text-xs uppercase tracking-wider px-4 py-3 rounded bg-reject text-space-950 font-black hover:bg-reject/90 transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer"
          onClick={onAcknowledge}
        >
